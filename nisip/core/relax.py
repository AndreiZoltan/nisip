...
def relax(sandpile: Union[Sandpile, DirectedSandpile] ) -> Union[Sandpile, DirectedSandpile]:
    """
    ...
    if sandpile.tiling == "square":
        ...
        if sandpile.is_directed:
            ...
            if sandpile.is_trivial_boundary:
                sandpile.set_graph(cns.relax_triangular_directed(sandpile.graph, *sandpile.directions))
        else:
            if sandpile.is_trivial_boundary:
